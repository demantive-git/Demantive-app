        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-4xl mx-auto animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <a
                href="/auth/signup"
                className="bg-gray-900 text-white px-8 py-4 rounded-lg font-medium hover:bg-gray-800 transition-all shadow-lg hover:shadow-xl text-lg"
              >
                Start free trial
              </a>
              <a
                href="#how-it-works"
                className="bg-white border border-gray-200 px-8 py-4 rounded-lg font-medium hover:bg-gray-50 hover:border-gray-300 transition-all text-lg"
              >
                See how it works
              </a>
            </div>
      ...
      <section id="features" className="py-24 bg-gray-50 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm hover:shadow-lg transition-all group">
              <div className="w-12 h-12 bg-success/10 rounded-lg flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                <svg
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm hover:shadow-lg transition-all group">
              <div className="w-12 h-12 bg-warning/10 rounded-lg flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                <svg
      ...
      <footer className="border-t border-gray-200 py-12 px-6 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="flex items-center gap-8">
              <p className="text-sm text-gray-600">© 2025 Demantive. All rights reserved.</p>
